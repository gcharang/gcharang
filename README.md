...
| **[vectorless-rag](https://github.com/ProofOfTechOrg/vectorless-rag)** | The parts that keep a research app honest: model-written SQL validated before it reaches Postgres, content-addressed artifacts with audited activation, a budgeted run's worst-case cost reserved before any paid model call | Python · FastAPI · LangGraph |
